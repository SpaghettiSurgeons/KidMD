...
public class toPulseOximeter extends AppCompatActivity implements View.OnClickListener {

    TextView pulseOximeterDesc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_to_pulse_oximeter);

        pulseOximeterDesc = findViewById(R.id.pulseOximeterDescView);
        ...
        (pulseOximeterDesc).setTypeface(baloo);
        ...
        pulseOximeterAudio.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                textToSpeech.speak(pulseOximeterDesc.getText().toString(), TextToSpeech.QUEUE_FLUSH, null);
            }
        });
        ...
        secondPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(toPulseOximeter.this, toPulseOximeter2.class));
            }
        });
    }
