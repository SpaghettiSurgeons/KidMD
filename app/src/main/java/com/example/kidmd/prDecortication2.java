...
public class prDecortication2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //audio
        decorAudio2 = findViewById(R.id.decorAudio2);
        decorDesc2 = findViewById(R.id.prDecorDesc2);
        ...
        decorAudio2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                textToSpeech.speak(decorDesc2.getText().toString(), TextToSpeech.QUEUE_FLUSH, null);
            }
        });

        //change font
        Typeface baloo = Typeface.createFromAsset(getAssets(), "fonts/Baloo-Regular.ttf");
        ((TextView) findViewById(R.id.Decortication2)).setTypeface(baloo);
        ((TextView) findViewById(R.id.prDecorTitle2)).setTypeface(baloo);
        (decorDesc2).setTypeface(baloo);
    }
