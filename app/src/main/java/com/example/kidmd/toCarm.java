...
public class toCarm extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_to_carm);

        carmDesc = findViewById(R.id.carmDescView);
        ...
        carmAudio.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                textToSpeech.speak(carmDesc.getText().toString(), TextToSpeech.QUEUE_FLUSH, null);
            }
        });
        ...
        secondPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(toCarm.this, toCarm2.class));
            }
        });
    }
