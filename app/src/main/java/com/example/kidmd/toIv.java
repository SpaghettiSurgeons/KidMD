...
public class toIv extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_to_iv);

        IvDesc = findViewById(R.id.IvDescView);
        ...
        ((TextView) findViewById(R.id.IvTitleView)).setTypeface(baloo);
        (IvDesc).setTypeface(baloo);
        ...
        IvAudio.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                textToSpeech.speak(IvDesc.getText().toString(), TextToSpeech.QUEUE_FLUSH, null);
            }
        });
