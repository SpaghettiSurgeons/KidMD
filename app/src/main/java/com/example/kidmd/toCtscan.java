...
public class toCtscan extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_to_ctscan);

        CtscanDesc = findViewById(R.id.CtscanDescView);
        ...
        CtscanAudio.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                textToSpeech.speak(CtscanDesc.getText().toString(), TextToSpeech.QUEUE_FLUSH, null);
            }
        });
        ...
        secondPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(toCtscan.this, toCtscan2.class));
            }
        });
    }
    public void onClick(View view) {
